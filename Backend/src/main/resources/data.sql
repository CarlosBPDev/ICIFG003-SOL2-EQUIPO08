...
-- =========================
INSERT IGNORE INTO horario_disponible (id, hora_inicio, hora_termino, sala_id) VALUES
(1,  '08:00', '10:00', 1),
(2,  '10:30', '12:30', 1),
(3,  '14:00', '16:00', 1),
(4,  '08:00', '10:00', 2),
...
-- =========================
INSERT IGNORE INTO reserva (id, fecha_reserva, observacion, fecha_creacion, estudiante_id, sala_id, horario_disponible_id, estado_reserva_id) VALUES
...
-- =========================
DELETE FROM usuario;
INSERT IGNORE INTO usuario (id, username, password_hash, rol, id_estudiante) VALUES
...
-- =========================
INSERT IGNORE INTO recurso (id, nombre_recurso, descripcion) VALUES
...
-- =========================
INSERT IGNORE INTO sala_recurso (sala_id, recurso_id) VALUES
(1, 1), (1, 2), (1, 5),
(2, 1), (2, 2), (2, 3), (2, 5),
(3, 1), (3, 2),
(4, 1), (4, 2), (4, 4), (4, 6),
...
-- Sincronizar auto_increment después de inserts con IDs explícitos
ALTER TABLE reserva AUTO_INCREMENT = 16;
ALTER TABLE estudiante AUTO_INCREMENT = 11;
ALTER TABLE sala AUTO_INCREMENT = 9;
ALTER TABLE horario_disponible AUTO_INCREMENT = 25;
ALTER TABLE carrera AUTO_INCREMENT = 6;
ALTER TABLE edificio AUTO_INCREMENT = 4;
ALTER TABLE usuario AUTO_INCREMENT = 11;
ALTER TABLE recurso AUTO_INCREMENT = 7;
