...
## Dónde se activa cada mensaje

| Mensaje | Origen | Archivo |
|---------|--------|---------|
| "No se pudo conectar con el servidor..." | Interceptor HTTP (`status === 0`) | `Frontend/src/app/interceptors/error-interceptor.ts` |
| "Error interno del servidor..." | Interceptor HTTP (`status >= 500`) | `Frontend/src/app/interceptors/error-interceptor.ts` |
| "Salas cargadas correctamente." | `SalasComponent.loadSalas()` | `Frontend/src/app/features/salas/pages/salas.component.ts` |
| "No se pudieron cargar las salas..." | `SalasComponent / ReservasComponent / ReservaFormComponent` | Múltiples archivos |
| "Error al buscar estudiantes..." | `EstudiantesComponent` / `ReservaFormComponent` | Múltiples archivos |
| "No se pudieron cargar las reservas..." | `ReservasComponent.loadReservas()` | `Frontend/src/app/features/reservas/pages/reservas.component.ts` |
| "Reserva creada exitosamente..." | `ReservaFormComponent.onSubmit()` | `Frontend/src/app/features/reservas/pages/reserva-form.component.ts` |
| "Ya existe una reserva confirmada..." | `ReservaFormComponent.onSubmit()` (conflicto 409) | `Frontend/src/app/features/reservas/pages/reserva-form.component.ts` |
